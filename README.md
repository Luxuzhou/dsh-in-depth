...
每章包含学习目标、核心问题、源码路标、动手实验、小结、思考题和求职面试题。配套实验位于 [`labs/`](labs/)，实验是否真正执行、需要什么环境以及证据位置记录在 [`docs/LAB_STATUS.md`](docs/LAB_STATUS.md)。

## 阅读路线

- 初学者：引言 → 第 1、2、3、5、6 章 → Lab 01、02。
- 插件作者：第 2、5、6、7、9 章 → Lab 02、03。
- 企业架构师：第 3、4、5、8、9、10 章 → Lab 04。
